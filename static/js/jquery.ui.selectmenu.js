...
$.widget("ui.selectmenu", {
	...
	_create: function() {
		...
		this.newelement = $( '<a />', {
			'class': this.widgetBaseClass + ' ui-widget ui-state-default ms_border',
			'id' : this.ids[ 0 ],
			'role': 'button',
			'href': '#',
		...
		// menu icon
		this.selectmenuIcon = $( '<span class="' + this.widgetBaseClass + '-icon select_button select-menu"><img src="/static/images/pulldown_arrow.png"/></span>' )
	...
	_init: function() {
		...
		this.list
			.toggleClass( self.widgetBaseClass + '-menu-dropdown ms_border select_menu', isDropDown )
